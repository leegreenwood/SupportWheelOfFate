...
```
    cd "SupportWheelOfFate.Lambda.AssignedEngineers"
    dotnet restore
```

Execute unit tests
```
    cd "SupportWheelOfFate.Lambda.AssignedEngineers/test/SupportWheelOfFate.Lambda.AssignedEngineers.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "SupportWheelOfFate.Lambda.AssignedEngineers/src/SupportWheelOfFate.Lambda.AssignedEngineers"
